...
public class NetworkMDI extends JFrame		
{
	...
	public NetworkMDI()
	{
		...
		JMenuItem readDBItem = new JMenuItem("Read Database");  
		fileMenu.add(openItem);
		fileMenu.add(readDBItem);
		...
		JMenuItem writeDBItem = new JMenuItem("Write Database");  
		JMenuItem writeListItem = new JMenuItem("Write Network List");   
		JMenuItem aboutItem = new JMenuItem("About");
		JMenuItem exitItem = new JMenuItem("Exit Program");
		exitMenu.add(writeDBItem);
		exitMenu.add(writeListItem);
	...
	/*	openItem.addActionListener(new ActionListener()
		...
		readDBItem.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				networkList = databaseMethods.getNetworks();	
			}
		});	
		...
		writeDBItem.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				databaseMethods.writePublicTable();
				databaseMethods.writeCommercialTable();
				databaseMethods.writeShowsTable();
				databaseMethods.writeActorsTable();			
			}
		});	

		writeListItem.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
			...
			submitButton.addActionListener(new ActionListener()
			{
				public void actionPerformed(ActionEvent ae)
				{
					...
					if(networkTypeBox.getSelectedIndex() == 1)
					{
						...
						result = databaseMethods.addPublicNetworks(networkField.getText(), ppaField.getText(), streetField.getText()+cityField.getText()+stateField.getText()+zipField.getText(), soField.getText());
					}
					else
					{
						networkList.add(new CommercialNetwork(networkField.getText(), ppaField.getText(), new Address(streetField.getText(), cityField.getText(), stateField.getText(), Integer.parseInt(zipField.getText())), soField.getText(), parentCompanyField.getText()));
						 ...
						 result = databaseMethods.addCommercialNetworks(networkField.getText(), ppaField.getText(), streetField.getText()+ "," + cityField.getText()+ "," + stateField.getText()+ "," + zipField.getText(), soField.getText(), parentCompanyField.getText());
					}
	...
	class ShowPanel extends JPanel
	{
				...
				public void actionPerformed(ActionEvent ae)
				{
					...
					for(Network n: networkList)
						if(n.getName().equals(networkField.getText()))
						{
							...
							result = databaseMethods.addShows(networkField.getText(), ntsField.getText(), ppaField.getText(), convertShowType(), Integer.parseInt(commercialTimeField.getText()));
						}
		...
		public Show.ShowType getShowType(String s)
		{
			if(s.equals("Comedy"))
					...
					{for(Network n: networkList)
						for(Show s: n.getSchedule())
							if(s.getTitle().equals(ntsField.getText()))
							{
								...
								result = databaseMethods.addActors(ntsField.getText(), ppaField.getText(), Integer.parseInt(ageField.getText()));
							}
